...
-- group11 [] = []
-- group11 [x] = [[x]]
-- group11 (h:t) | (h == head hr ) = ((h:hr):tr)
--               | otherwise = ([h]:hr:tr)
--                   where (hr:tr) = group11 t
-- 12
concat12 :: [[a]] -> [a]
concat12 [[]] = []
...
intersect30 [] _ = []
intersect30 _ [] = []
intersect30 (x:xs) (y:ys) | x == y = x : intersect30 xs ys
                          | otherwise = intersect30  xs (y:ys)
-- 31
...
-- 34
-- pMaior34 :: Ord a => [a] -> Int
-- pMaior34 [] = 0 
-- pMaior34 (h:t) = auxPMaior34 (h:t) 0 
-- 
-- auxPMaior34 :: Ord a => [a] -> Int -> Int
-- auxPMaior34 [] _ = 0
-- auxPMaior34 (x:xs:t) p | x>=xs = p+1 + auxPMaior34 xs
--                        | otherwise 
...
-- 43
-- constroiMSet43 :: Ord a => [a] -> [(a,Int)]
-- constroiMSet43 (x:xs:xss) | x == xs = (x,)
...
caminho46 (xi,yi) (xf,yf) | yi < yf = Norte : caminho46 (xi,yi+1) (xf,yf)
                          ...
                          | otherwise = []
-- 47
-- hasloops46 :: (Int,Int) -> [Movimento] -> Bool
-- LOADING ...
